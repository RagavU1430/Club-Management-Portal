...
export default function NextUpcomingEvent() {
  ...
  if (!event) {
    return (
      <section className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="relative rounded-3xl overflow-hidden glass p-8 sm:p-10 border border-white/10 text-center shadow-xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-cyan-400/10 border border-cyan-400/20 px-3 py-1 text-xs font-mono text-cyan-300 mb-4">
          ...
          <div className="mt-6 flex justify-center">
            <Link
              to="/events"
              className="inline-flex items-center gap-2 rounded-xl glass px-6 py-2.5 text-sm font-semibold text-white hover:bg-white/10 transition border border-white/10"
            >
  ...
  return (
    <>
      <section className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative rounded-3xl overflow-hidden glass border border-cyan-400/30 p-6 sm:p-10 shadow-[0_0_50px_rgba(0,240,255,0.12)] transition-all duration-300">
          {/* Subtle Ambient Background Gradients */}
          <div className="pointer-events-none absolute -top-32 -right-32 h-80 w-80 rounded-full bg-cyan-500/15 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-32 -left-32 h-80 w-80 rounded-full bg-purple-600/15 blur-3xl" />

          {/* Top Bar: Live Status & Category */}
          <div className="relative z-10 flex flex-wrap items-center justify-between gap-3 mb-6">
            <div className="inline-flex items-center gap-2 rounded-full bg-cyan-400/10 border border-cyan-400/30 px-3.5 py-1 text-xs font-mono text-cyan-300 shadow-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              {event.capacity ? (
                <span className="rounded-full bg-purple-500/10 border border-purple-500/20 px-3 py-1 text-xs font-mono text-purple-300 flex items-center gap-1.5">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              <h3 className="font-display text-2xl sm:text-4xl font-black text-white glow-text leading-tight">
                {event.title}
              </h3>
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4 text-xs font-mono text-slate-300">
                <div className="flex items-center gap-2 rounded-xl glass-subtle border border-white/10 px-3.5 py-2">
                ...
                <div className="flex items-center gap-2 rounded-xl glass-subtle border border-white/10 px-3.5 py-2 truncate max-w-xs">
            ...
            <div className="lg:col-span-5 flex flex-col items-center lg:items-end justify-center">
              <div className="w-full max-w-md rounded-2xl glass-subtle border border-white/10 p-5 space-y-5 text-center shadow-lg">
                {/* Countdown Header */}
                <div className="flex items-center justify-center gap-2 text-xs font-mono text-cyan-300 font-semibold tracking-wider uppercase">
                ...
                {timeLeft && !timeLeft.isStarted && (
                  <div className="grid grid-cols-4 gap-2 text-center">
                    <div className="rounded-xl bg-[#050811]/70 border border-cyan-400/20 py-2.5 px-1">
                      <span className="block font-mono text-2xl sm:text-3xl font-bold text-white glow-text">
                    ...
                    <div className="rounded-xl bg-[#050811]/70 border border-cyan-400/20 py-2.5 px-1">
                      <span className="block font-mono text-2xl sm:text-3xl font-bold text-cyan-300 glow-text">
                ...
                <div className="space-y-2.5 pt-1">
                  {event.registrationLink ? (
                    <a
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 py-3 text-sm font-bold text-white shadow-lg shadow-cyan-500/25 transition hover:scale-[1.02] cursor-pointer"
                    >
                  ...
                  <Link
                    to="/events"
                    className="w-full inline-flex items-center justify-center gap-2 rounded-xl glass py-2.5 text-xs font-semibold text-slate-300 hover:text-white transition border border-white/5 hover:border-white/20"
                  >
