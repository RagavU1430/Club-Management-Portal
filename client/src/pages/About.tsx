  ...
  return (
    <main className="relative min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto mb-16">
        <div className="relative group inline-flex items-center gap-2.5 rounded-full px-5 py-2 text-xs font-mono tracking-widest font-extrabold backdrop-blur-xl mb-4 transition-all duration-300 hover:scale-[1.03]
        ...
        >
          ...
          <Sparkles className="h-4 w-4 text-[#e1306c] dark:text-cyan-300 shrink-0 transition-transform duration-300 group-hover:rotate-12" />
        ...
        <h1 className="font-display text-4xl sm:text-6xl font-black text-slate-900 dark:text-white glow-text">
      ...
      <section className="relative z-10 rounded-3xl glass p-8 sm:p-12 border border-slate-200/80 dark:border-white/10 mb-20 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="mt-2 font-display text-2xl sm:text-4xl font-bold text-slate-900 dark:text-white">
        ...
        {ACHIEVEMENTS.map((a) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-6">
                <div className="font-display text-3xl font-black text-slate-900 dark:text-white">{a.label}</div>
                <p className="mt-2 text-xs text-slate-500 dark:text-slate-400 leading-relaxed">{a.desc}</p>
              </div>
            </div>
          );
        })}
      ...
      <section className="relative z-10 mb-20">
        <div className="text-center max-w-xl mx-auto mb-12">
          ...
          <h2 className="mt-2 font-display text-3xl font-bold text-slate-900 dark:text-white">Evolution of the Guild</h2>
        </div>
          ...
          {TIMELINE.map((item, idx) => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-[10px] font-mono text-slate-400 dark:text-slate-500">STAGE 0{idx + 1}</span>
              </div>
      ...
      <section className="relative z-10 mb-20">
        <div className="text-center max-w-xl mx-auto mb-12">
          ...
          <h2 className="mt-2 font-display text-3xl font-bold text-slate-900 dark:text-white">Alumni & Member Impact</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t) => (
            <div key={t.name} className="rounded-2xl glass p-6 border border-slate-200/80 dark:border-white/10 flex flex-col justify-between shadow-sm hover:shadow-md transition">
              <Quote className="h-6 w-6 text-cyan-500/40 dark:text-cyan-400/40 mb-4" />
              ...
              <div className="mt-6 pt-4 border-t border-slate-200 dark:border-white/5">
                ...
                <div className="text-xs text-cyan-700 dark:text-cyan-300 font-mono mt-0.5">{t.role}</div>
              </div>
            </div>
          ))}
        </div>
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 text-left font-medium text-slate-800 dark:text-white hover:text-cyan-600 dark:hover:text-cyan-300 transition cursor-pointer"
                >
                ...
                {isOpen && (
                  <div className="px-5 pb-5 pt-1 text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-slate-200 dark:border-white/5">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      {/* Bottom CTA */}
      <section className="relative z-10 rounded-3xl overflow-hidden border border-cyan-500/30 bg-gradient-to-r from-cyan-500/10 via-white to-purple-500/10 dark:from-cyan-950/40 dark:via-[#070b16] dark:to-purple-950/40 p-10 text-center shadow-xl backdrop-blur-md">
        <h2 className="font-display text-2xl sm:text-4xl font-black text-slate-900 dark:text-white glow-text">
          Join the Movement
        </h2>
        <p className="mt-3 text-slate-600 dark:text-slate-300 text-sm max-w-lg mx-auto">
